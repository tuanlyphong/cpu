...
public class SchedulingGUI extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 9)); // NOI10N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("# of Process:");
        jPanel1.add(jLabel2, new AbsoluteConstraints(220, 290, 130, 30));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(jComboBox1, new AbsoluteConstraints(390, 190, 140, 30));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 9)); // NOI10N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Algorithm:");
        jPanel1.add(jLabel3, new AbsoluteConstraints(220, 190, 100, 30));
        ...
        jPanel1.add(jButton1, new AbsoluteConstraints(390, 240, 140, 30));

        jButton2.setFont(new java.awt.Font("Tahoma", 3, 6)); // NOI10N
        ...
        jPanel1.add(jButton2, new AbsoluteConstraints(0, 300, 100, 30));

        jLabel4.setFont(new java.awt.Font("Bookman Old Style", 1, 28)); // NOI10N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("CPU Scheduling");
        jPanel1.add(jLabel4, new AbsoluteConstraints(100, 10, 420, 80));

        jLabel1.setFont(new java.awt.Font("Bookman Old Style", 3, 9)); // NOI10N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Simulation");
        jPanel1.add(jLabel1, new AbsoluteConstraints(310, 90, 120, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 9)); // NOI10N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Source:");
        jPanel1.add(jLabel5, new AbsoluteConstraints(220, 240, 70, 30));

        jTextField1.setText("0");
        jPanel1.add(jTextField1, new AbsoluteConstraints(390, 290, 140, 30));

        nextStep2.setFont(new java.awt.Font("Tahoma", 1, 7)); // NOI10N
        ...
        jPanel1.add(nextStep2, new AbsoluteConstraints(310, 370, 130, 40));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 6)); // NOI10N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("(0 <= N <= 10)");
        jPanel1.add(jLabel6, new AbsoluteConstraints(550, 290, 120, 30));

        jLabel7.setIcon(new javax.swing.ImageIcon("D:\\Programming Files\\CPUSchedulingSimulation\\src\\main\\java\\dark-abstract-tech-background_53876-90630.jpg")); // NOI10N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(null, "Developers:Pham Tuan Phong 20214039");
