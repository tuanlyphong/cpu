...
public class CalcSimulation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new AbsoluteConstraints(0, 400, 330, 50));

        jProgressBar1.setBackground(new java.awt.Color(0, 153, 255));
        jPanel1.add(jProgressBar1, new AbsoluteConstraints(580, 70, 100, 30));

        jLabel2.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Ready Queue");
        jPanel1.add(jLabel2, new AbsoluteConstraints(110, 370, 120, 20));
        ...
        jPanel1.add(jLabel13, new AbsoluteConstraints(810, 20, 120, 30));
        ...
        jPanel1.add(jLabel18, new AbsoluteConstraints(580, 20, 100, 30));
